...
- using the ping() and iperf() tests from Wmnet()
...
from apns.node import UserSwitch, OVSKernelSwitch, Controller
from apns.topo import Topo
from apns.util import irange, quietRun
...
def linearBandwidthTest(lengths):
    ...
    for datapath in switches.keys():
        ...
        net = Wmnet(topo=topo, switch=Switch,
