...
from apns.link import wmediumd, _4address
...
def topology(args):
    ...
    ap1 = net.addAP('ap1', ssid="ap1-ssid", mode="g",
                             channel="1", position='30,30,0')
    ap2 = net.addAP('ap2', ssid="ap2-ssid", mode="g",
                             channel="1", position='40,60,0')
    ap3 = net.addAP('ap3', ssid="ap3-ssid", mode="g",
                             channel="1", position='50,30,0')
    sta1 = net.addSta('sta1', ip="192.168.0.1/24", position='31,32,0')
    sta2 = net.addSta('sta2', ip="192.168.0.2/24", position='32,34,0')
    sta3 = net.addSta('sta3', ip="192.168.0.3/24", position='41,62,0')
    sta4 = net.addSta('sta4', ip="192.168.0.4/24", position='42,64,0')
    sta5 = net.addSta('sta5', ip="192.168.0.5/24", position='51,32,0')
    sta6 = net.addSta('sta6', ip="192.168.0.6/24", position='52,34,0')
