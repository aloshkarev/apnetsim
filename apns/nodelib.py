"""
Node Library for AP Network Simulator
This contains additional Node types which you may find to be useful.
"""

from apns.log import info, warn
from apns.moduledeps import pathCheck
from apns.node import AP, Node, Switch
...
class LinuxBridgeSwitch(Switch):
    ...
    def __init__(self, name, stp=False, prio=None, **kwargs):
        ...
        if prio:
            ...
            self.prio = LinuxBridgeSwitch.nextPrio
            LinuxBridgeSwitch.nextPrio += 1
    ...
    def stop(self, deleteIntfs=True):
        ...
        self.cmd('ifconfig', self, 'down')
        self.cmd('brctl delbr', self)
        super(LinuxBridgeSwitch, self).stop(deleteIntfs)
...
class NAT(Node):
    ...
    def __init__(self, name, subnet='10.0/8',
        ...
        """Start NAT/forwarding between Wmnet and external network
           subnet: Wmnet subnet (default 10.0/8)
    ...
    def terminate(self):
        """Stop NAT/forwarding between Wmnet and external network"""
        # Remote NAT rules
