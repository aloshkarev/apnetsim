...
def makeTerm(node, title='Node', term='xterm', display=None, cmd='sh'):
    ...
    from apns.docker import Docker, DockerSta, DockerAP, DockerWLC
    if isinstance(node, Docker) or isinstance(node, DockerSta) or isinstance(node, DockerAP) or isinstance(node,
                                                                                                           DockerWLC):
