"""Logging functions for Wmnet."""

import logging
import types
from logging import Logger

# Create a new loglevel, 'CLI info', which enables a Wmnet user to see only
...
class MininetLogger(Logger, object):
    """Mininet-specific logger
       ...
       from mn-wifi.log import [lg, info, error]
